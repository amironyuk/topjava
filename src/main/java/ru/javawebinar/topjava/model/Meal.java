...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.IN_DATETIME_RANGE_SORTED, query = "SELECT m FROM Meal m WHERE m.user=:user" +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String IN_DATETIME_RANGE_SORTED = "Meal.getBetweenHalfOpen";
